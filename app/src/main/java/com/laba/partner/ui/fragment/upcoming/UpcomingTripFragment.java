...
import com.laba.partner.ui.activity.upcoming_detail.UpcomingTripDetailActivity;
import com.laba.partner.ui.adapter.UpcomingTripAdapter;
...
public class UpcomingTripFragment extends BaseFragment implements UpcomingTripIView,
    ...
    public void cancelRide(HistoryList historyList, int pos) {
        ...
        BaseActivity.DATUM_history = historyList;
        SharedHelper.putKey(getContext(), Constants.SharedPref.cancel_id, String.valueOf(BaseActivity.DATUM_history.getId()));
