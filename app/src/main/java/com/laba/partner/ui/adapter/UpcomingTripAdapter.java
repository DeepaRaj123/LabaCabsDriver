...
public class UpcomingTripAdapter extends RecyclerView.Adapter<UpcomingTripAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        try {
            SimpleDateFormat smf = new SimpleDateFormat("yyyy-MM-dd hh:mm aa");
            Date d = smf.parse(historyList.getScheduleAt());

            SimpleDateFormat smfM = new SimpleDateFormat("dd MMM yyyy hh:mm aa");
            String date = smfM.format(d);
            Log.e("DATE FORMATTED: ", date);
            holder.lblDate.setText(date);
        } catch (Exception e) {
            Log.e("DATE UNFORMATTED: ", historyList.getScheduleAt());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView lblBookingid;
        private final TextView lblSeviceName;
        private final ImageView staticMap;
        private final Button btnCancelRide;
